        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NIPC = table.Column<string>(nullable: false),
                    DateOfCreation = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GuyName = table.Column<string>(nullable: true),
                    ProdReferenceCode = table.Column<string>(nullable: false),
                    Trouble = table.Column<string>(maxLength: 200, nullable: false),
                    Remedy = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductModel_ManufacturerId",
                table: "ProductModel",
